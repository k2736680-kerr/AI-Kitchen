...
export const INGREDIENT_FIXTURES: readonly IngredientDefinition[] = [
  { id: 'egg', displayName: '鸡蛋', aliases: ['蛋', '鸡子'], category: 'egg', allergenCodes: ['egg.chicken'] },
  ...
  { id: 'noodles', displayName: '面条', aliases: ['挂面', '面'], category: 'staple', allergenCodes: ['wheat.common'] },
];
