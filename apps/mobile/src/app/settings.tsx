...
export default function SettingsScreen() {
  ...
  return <Screen><AppHeader title={t('settings.title')} eyebrow={t('settings.eyebrow')} back />
    ...
    </AppCard><AppCard><ThemedText type="sectionTitle">{t('settings.about')}</ThemedText><ThemedText>{t('common.appName')}</ThemedText><ThemedText type="small" themeColor="textSecondary">{t('settings.version', { version: getAppVersion() })}</ThemedText></AppCard></Screen>;
}
