...
/** Recipe ingredient text is generated content and stays in the recipe's own locale. */
export function presentRecipeIngredient(ingredient: RecipeIngredient, locale: IngredientLocale): string { return ingredient.displayName || presentIngredientId(ingredient.ingredientId, locale); }
