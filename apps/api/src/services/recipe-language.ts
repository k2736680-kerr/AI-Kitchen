...
/**
 * A deliberately lightweight fail-closed check for a provider response. It only
 * examines generated narrative fields, never stable IDs or user-entered custom
 * ingredient text.
 */
